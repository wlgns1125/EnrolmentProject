...
public class Client {
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException{
        ...
        Protocol ID전송 = new Protocol(Protocol.PT_LOGIN, Protocol.LOGIN_UT_ID전송);
        Protocol PASSWORD전송 = new Protocol(Protocol.PT_LOGIN, Protocol.LOGIN_UT_PASSWORD전송);
        Protocol EXIT = new Protocol(Protocol.PT_EXIT, Protocol.PT_UNDEFINED);

        Protocol 교수_개인정보수정요청 = new Protocol(Protocol.PT_PROFESSOR, Protocol.PROFESSOR_UT_개인정보_수정_요청);
        Protocol 강의계획서입력요청 = new Protocol(Protocol.PT_PROFESSOR, Protocol.PROFESSOR_UT_강의계획서_입력_요청);
        Protocol 강의계획서수정요청 = new Protocol(Protocol.PT_PROFESSOR, Protocol.PROFESSOR_UT_강의계획서_수정_요청);
        Protocol 교수_개설과목조회요청 = new Protocol(Protocol.PT_PROFESSOR,Protocol.PROFESSOR_UT_교과목_목록_조회_요청);
        Protocol 교수_교과목수강신청학생목록조회요청 = new Protocol(Protocol.PT_PROFESSOR,Protocol.PROFESSOR_UT_교과목_수강신청_학생_목록_조회_요청);
        Protocol 교수_개설교과목강의계획서조회요청 = new Protocol(Protocol.PT_PROFESSOR, Protocol.PROFESSOR_UT_교과목_강의계획서_조회_요청);
        Protocol 교수_강의계획서ID요청 = new Protocol(Protocol.PT_PROFESSOR, Protocol.PROFESSOR_UT_강의계획서_ID_요청);
        Protocol 교수_비밀번호수정요청 = new Protocol(Protocol.PT_PROFESSOR, Protocol.PROFESSOR_UT_비밀번호_수정_요청);
        Protocol 교수시간표조회요청 = new Protocol(Protocol.PT_PROFESSOR, PROFESSOR_UT_교과목_시간표_조회_요청);
        Protocol 교수_강의계획서입력기간확인요청 = new Protocol(Protocol.PT_PROFESSOR, Protocol.PROFESSOR_UT_강의계획서_입력_기간_확인_요청);


        Protocol 학생_개인정보수정요청 = new Protocol(Protocol.PT_STUDENT, Protocol.STUDENT_UT_개인정보_수정_요청);
        Protocol 수강신청요청 = new Protocol(Protocol.PT_STUDENT, Protocol.STUDENT_UT_수강신청_요청);
        Protocol 수강삭제요청 = new Protocol(Protocol.PT_STUDENT, Protocol.STUDENT_UT_수강삭제_요청);
        Protocol 개설교과목조회요청 = new Protocol(Protocol.PT_STUDENT,Protocol.STUDENT_UT_개설교과목_조회_요청);
        Protocol 학생_선택교과목강의계획서조회요청 = new Protocol(PT_STUDENT,STUDENT_UT_선택교과목_강의계획서_조회_요청);
        Protocol 학생_비밀번호수정요청 = new Protocol(Protocol.PT_STUDENT, Protocol.STUDENT_UT_비밀번호_수정_요청);
        Protocol 수강신청본인현황요청 = new Protocol(Protocol.PT_STUDENT, Protocol.STUDENT_UT_수강신청_본인현황_요청);
        Protocol 학생시간표조회요청 = new Protocol(PT_STUDENT,STUDENT_UT_본인시간표_조회_요청);

        Protocol 교과목생성요청 = new Protocol(Protocol.PT_MANAGER, Protocol.MANAGER_UT_교과목_생성_요청);
        Protocol 교과목수정요청 = new Protocol(Protocol.PT_MANAGER, Protocol.MANAGER_UT_교과목_수정_요청);
        Protocol 교과목삭제요청 = new Protocol(Protocol.PT_MANAGER, Protocol.MANAGER_UT_교과목_삭제_요청);
        Protocol 개설교과목생성요청 = new Protocol(Protocol.PT_MANAGER, Protocol.MANAGER_UT_개설교과목_생성_요청);
        Protocol 개설교과목수정요청 = new Protocol(Protocol.PT_MANAGER, Protocol.MANAGER_UT_개설교과목_수정_요청);
        Protocol 개설교과목삭제요청 = new Protocol(Protocol.PT_MANAGER, Protocol.MANAGER_UT_개설교과목_삭제_요청);
        Protocol 강의계획서입력기간설정요청 = new Protocol(Protocol.PT_MANAGER, Protocol.MANAGER_UT_강의계획서_입력기간설정_요청);
        Protocol 수강신청기간설정요청 = new Protocol(Protocol.PT_MANAGER, Protocol.MANAGER_UT_학년별_수강신청기간설정_요청);
        Protocol 교수정보조회요청 = new Protocol(Protocol.PT_MANAGER, Protocol.MANAGER_UT_교수_정보_조회_요청);
        Protocol 학생정보조회요청 = new Protocol(Protocol.PT_MANAGER, Protocol.MANAGER_UT_학생_정보_조회_요청);
        Protocol 개설교과목정보조회요청 = new Protocol(Protocol.PT_MANAGER, Protocol.MANAGER_UT_개설_교과목_정보_조회_요청);
        Protocol 관리자계정생성요청 = new Protocol(Protocol.PT_MANAGER, Protocol.MANAGER_UT_관리자계정_생성_요청);
        Protocol 교수계정생성요청 = new Protocol(Protocol.PT_MANAGER, Protocol.MANAGER_UT_교수_계정_생성_요청);
        Protocol 학생계정생성요청 = new Protocol(Protocol.PT_MANAGER, Protocol.MANAGER_UT_학생_계정_생성_요청);
        Protocol 개설교과목정보조회목록선택 = new Protocol(Protocol.PT_MANAGER, Protocol.MANAGER_UT_개설_교과목_정보_조회_목록선택);
        Protocol 교과목목록요청 = new Protocol(Protocol.PT_MANAGER, Protocol.MANAGER_UT_교과목_목록_조회_요청);
